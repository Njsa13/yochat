...
import { getContacts, getMessages, getSingleContact, sendMessage } from "../controllers/messageController.js";
...
router.get("/contact/:email", isAuthenticated, getSingleContactValidator, validate, getSingleContact);
