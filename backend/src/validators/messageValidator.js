...
export const getMessagesValidator = [param("chatRoomId").notEmpty().withMessage("Chat Room Id required")];

export const getSingleContactValidator = [param("email").notEmpty().withMessage("Email required")];
